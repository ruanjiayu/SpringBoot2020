...
public class HttpUtil {
     ...
     * @param url
     * @param data 对象数据
     * @param responseClass 服务端响应的返回体
     * @param config 配置
     * @param <T>
     * @return
     * @throws IOException
     */
    public static <T> T post(String url, Object data, Class<T> responseClass, ClientConfiguration config) throws IOException {
        String result = post(url, JsonUtil.obj2Str(data), config);
        return JsonUtil.str2Obj(result, responseClass);
    }
